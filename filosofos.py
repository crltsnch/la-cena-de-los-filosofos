...
class filosofo(threading.Thread):
    ...
    def soltar(self):
        ...
        self.verificar(self.izquierda(self.id))  #se comprueba si el filosofo de la izquierda puede comer
        self.verificar(self.derecha(self.id))  #igual que antes pero para el filosofo de la izquierda
